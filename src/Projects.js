                    ...
                    <div className="card project-card">
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          Website that allows parents to store memories about
                          their baby’s first years virtually. Includes a social
                          media component where users can share and comment
                          about funny stories.
                          <span>
